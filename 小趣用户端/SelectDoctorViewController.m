...
@interface SelectDoctorViewController ()<UITableViewDataSource,UITableViewDelegate,HeaderTableViewDataSource,HeaderTableViewDelegate>
...
- (void)loadData{
    self.fldData = @[@"妇科",@"产科",@"儿科",@"骨科",@"内科",@"外科",@"耳鼻喉科",@"大肠科"];
