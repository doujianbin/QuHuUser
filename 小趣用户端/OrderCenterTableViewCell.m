...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        UIView *backView = [[UIView alloc]initWithFrame:CGRectMake(7.5, 0, SCREEN_WIDTH - 15, 142)];
        [self addSubview:backView];
        [backView setBackgroundColor:[UIColor whiteColor]];
        backView.layer.cornerRadius = 3;
        backView.layer.masksToBounds = YES;
//        backView.layer.shadowOffset = CGSizeMake(0, 3);
//        backView.layer.shadowOpacity = 0.80;
//        backView.layer.shadowRadius = 3;
//        backView.layer.shadowColor = [[UIColor colorWithHexString:@"#000000" alpha:0.6] CGColor];
...
//        backView.layer.shadowRadius = 3;//阴影半径，默认3
        ...
        UIImageView *img1 = [[UIImageView alloc]initWithFrame:CGRectMake(0, 35, SCREEN_WIDTH - 15, 0.5)];
        [backView addSubview:img1];
        [img1 setBackgroundColor:[UIColor colorWithHexString:@"#E6E6E8"]];
        
        self.imgStatus = [[UIImageView alloc]initWithFrame:CGRectMake(15, 10, 15, 15)];
        ...
        self.lab_timeStatus = [[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH - 172.5, 15, 150, 15)];
        ...
        [self.lab_timeStatus setTextAlignment:NSTextAlignmentRight];
